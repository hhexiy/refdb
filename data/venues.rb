...
def webpage(year, url); [article('Accessed online at ' + url, year, nil)] end
...
def sigdial(year); [inproceedings(Name.new('Special Interest Group on Discourse and Dialogue', 'SigDial'), year)] end
