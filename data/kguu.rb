...
entry!('ranzato2015sequence',
  arxiv(2015, '1511.06732'),
...
entry!('narasimhan2015language',
  arxiv(2015, '1506.08941'),
...
entry!('narasimhan2016improving',
  arxiv(2016, '1603.07954'),
...
entry!('nachum2016improving',
  arxiv(2016, '1611.09321'),
...
entry!('williams1992simple',
  article('Machine learning', 1992, 8),
...
entry!('williams1991function',
  article('Connection Science', 1991, 3),
...
entry!('venkatraman2015improving',
  aaai(2015),
